...
public class ThreadLocalTest {
    ...
    private static class MyTask implements Runnable {
        ...
        @Override
        public void run() {
            System.out.println("cn/maxlu/java/learn/lang/thread " + threadName.get() + "start, transactionId=" + transactionId.get());
            ...
            System.out.println("cn/maxlu/java/learn/lang/thread " + threadName.get() + "stop , transactionId=" + transactionId.get());
